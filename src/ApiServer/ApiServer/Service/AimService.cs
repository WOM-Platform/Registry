...
namespace WomPlatform.Web.Api.Service {
    public class AimService {
        ...
        private readonly static Aim[] Aims = [
        ...
        private readonly static ImmutableDictionary<string, Aim> AimsByCode = ImmutableDictionary<string, Aim>.Empty;

        private readonly static ImmutableArray<Aim> FlatAims = [];

        static AimService() {
            // Prepare dictionary access by code
            void RecursiveAddToDictionary(Aim[] list, Dictionary<string, Aim> target) {
                foreach(Aim aim in list) {
