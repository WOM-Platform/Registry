...
namespace WomPlatform.Web.Api.Utilities {
    public class CsvFileHelper {
        public static byte[] GenerateCsvContent(VoucherGenerationRedemptionStatsResponse genRedResponse,
            ...
            // Add source ranks totals and aim breakdowns
            foreach (var source in genRedResponse.SourceRank)
            {
                // Instrument Generated total
                csvData.Add(new {
                    Period = "",
                    Metric = "Rank",
                    Value = source.TotalGeneratedAmount,
                    Merchant_ID = "",
                    Merchant_Name = "",
                    Source_ID = "",
                    ...
                    Aim_Code = "",
                    Aim_Name = "",
                    Rank_Type = "Instrument Generated",
                    Rank_Position = source.Rank,
                    Rank_Name = source.Name
                });

                // Instrument Redeemed total
                csvData.Add(new {
                    Period = "",
                    Metric = "Rank",
                    Value = source.TotalRedeemedAmount,
                    Merchant_ID = "",
                    Merchant_Name = "",
                    Source_ID = "",
                    Source_Name = source.Name,
                    Aim_Code = "",
                    Aim_Name = "",
                    Rank_Type = "Instrument Redeemed",
                    Rank_Position = source.Rank,
                    Rank_Name = source.Name
                });

                // Add one row per aim dynamically
                foreach (var aim in source.AimBreakdown)
                {
                    csvData.Add(new {
                        Period = "",
                        Metric = "Generated by Aim",
                        Value = aim.Sum,
                        Merchant_ID = "",
                        Merchant_Name = "",
                        Source_ID = "",
                        Source_Name = source.Name,
                        Aim_Code = aim.AimCode,
                        Aim_Name = aim.AimCode,
                        Rank_Type = "",
                        Rank_Position = "",
                        Rank_Name = ""
                    });
